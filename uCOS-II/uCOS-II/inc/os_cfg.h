...
#define OS_HIGHEST_PRIO           5u
#define OS_LOWEST_PRIO           63u   /* Defines the lowest priority that can be assigned ...         */
                                       /* ... MUST NEVER be higher than 254!                           */

#define OS_MAX_MUTEXS			 16u
#define OS_MAX_EVENTS           (24u+ 8/*KI_TASK_ID_END*/ + 8/*DEV_MAX_ID*/ /*reserved for device*/ + OS_MAX_MUTEXS/* mutex */)   /* Max. number of event control blocks in your application      */
...
#define OS_TLS_TBL_SIZE           5u   /* Size of Thread-Local Storage Table                           */
                                       ...
                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE     16u   /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE    16u   /* Statistics task stack size (# of OS_STK wide entries)        */
